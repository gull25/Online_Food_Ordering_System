...
const ActiveDeliveries = () => {
    ...
    return (
        <div className="font-inter flex flex-col lg:flex-row min-h-screen bg-background text-on-background">
            <RiderSidebar activeTab="active-deliveries" />
            ...
            <RiderBottomNav activeTab="active-deliveries" />
        </div>
    );
};
